  ...
  return (
    <>
      ...
      <div
        ...
        className="absolute inset-0 bg-primary z-40 h-[100vh] md:px-[100px] px-8 flex items-center justify-between max-sm:flex-col pb-32 pt-10"
      >
        <div
