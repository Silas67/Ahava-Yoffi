...
const Footer = () => {
  ...
  return (
    <section className="h-screen  w-full text-black flex flex-col font-sans p-8 gap-8 justify-between bg-white">
      {/* Navlinks */}
      <div className="flex items-center">
        <div className="grid grid-row-4 lg:grid-cols-4 ">
          {footerLinks.map((footer, id) => (
            <div key={id} className="space-y-4">
              ...
              <button
                ...
                className="flex justify-between items-center w-full text-lg font-sans tracking-wider uppercase touch-pan-up"
              >
                {footer.heading}
                {openSection === id ? (
              ...
              {/* Collapsible Links */}
              <ul
                className={`mt-2 space-y-2 text-neutral-800 text-sm overflow-hidden lg:overflow-visible transition-all duration-300 ease-in-out cursor-pointer ${openSection === id ? "max-h-full p-2" : " max-h-0 p-0"
                  }`}
              >
          ...
          <div className="flex items-start md:flex-col gap-4 mt-4 md:mt-0 md:col-span-2 lg:col-span-1">
            <h1 className="uppercase tracking-wider">About</h1>
      ...
      <div className="w-full text-center flex items-center justify-center font-sans">
        <h1 className="text-[300px] uppercase fontRanade leading-28">
          <span className="text-neutral-700">Ffi</span>.Ahava.
          <span className="text-neutral-700">Yo</span>{" "}
        </h1>
      </div>
    </section>
  );
